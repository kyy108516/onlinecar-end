var ValidateSQL = {
    ...
    query:"select a.*,c.license,c.vin,d.model from contract_validate as a,contract_list as b,car_list as c,car_type as d where a.contract_id=b.id and b.car_id=c.id and c.cartype=d.id and a.type='交车'",
